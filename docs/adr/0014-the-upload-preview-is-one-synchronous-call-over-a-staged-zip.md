...
ADR-0007's rail is the durable signal regardless, parking every Unlinked card beside
the text it used to hold. Matching now happens once, in the confirm, against the
Thread set read inside that transaction.
